...
from haystack.backends import BaseSearchBackend, BaseSearchQuery, log_query, BaseEngine
from haystack.constants import FILTER_SEPARATOR
from haystack.models import SearchResult
from simple_backend import SimpleSearchQuery
...
class DummySearchEngine(BaseEngine):
